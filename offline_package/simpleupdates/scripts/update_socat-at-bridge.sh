...
install_at_socat() {
    ...
    cp "$OFFLINE_DIR/socat-at-bridge/socat-armel-static" .
    cp "$OFFLINE_DIR/socat-at-bridge/killsmd7bridge" .
    cp "$OFFLINE_DIR/socat-at-bridge/atcmd" .
	cp "$OFFLINE_DIR/socat-at-bridge/atcmd11" .
    cd $SOCAT_AT_SYSD_DIR
    cp "$OFFLINE_DIR/socat-at-bridge/systemd_units/socat-smd11.service" .
    cp "$OFFLINE_DIR/socat-at-bridge/systemd_units/socat-smd11-from-ttyIN.service" .
    cp "$OFFLINE_DIR/socat-at-bridge/systemd_units/socat-smd11-to-ttyIN.service" .
    cp "$OFFLINE_DIR/socat-at-bridge/systemd_units/socat-killsmd7bridge.service" .
    cp "$OFFLINE_DIR/socat-at-bridge/systemd_units/socat-smd7-from-ttyIN2.service" .
    cp "$OFFLINE_DIR/socat-at-bridge/systemd_units/socat-smd7-to-ttyIN2.service" .
    cp "$OFFLINE_DIR/socat-at-bridge/systemd_units/socat-smd7.service" .
