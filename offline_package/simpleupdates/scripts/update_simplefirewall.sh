...
install_simple_firewall() {
    ...
    cp "$OFFLINE_DIR/simplefirewall/simplefirewall.sh" "$SIMPLE_FIREWALL_DIR/simplefirewall.sh"
    cp "$OFFLINE_DIR/simplefirewall/ttl-override" "$SIMPLE_FIREWALL_DIR/ttl-override"
    cp "$OFFLINE_DIR/simplefirewall/ttlvalue" "$SIMPLE_FIREWALL_DIR/ttlvalue"
    ...
    cp "$OFFLINE_DIR/simplefirewall/systemd/simplefirewall.service" "$SIMPLE_FIREWALL_SYSTEMD_DIR/simplefirewall.service"
    cp "$OFFLINE_DIR/simplefirewall/systemd/ttl-override.service" "$SIMPLE_FIREWALL_SYSTEMD_DIR/ttl-override.service"
